...
class CartListApiView(APIView):
    ...
    def post(self, request):
        ...
        if product_instance is not None and product_instance.is_available:
            available_stock = product_instance.available_stock
            if available_stock >= quantity:
                unit_price = product_instance.unit_price
                total_cost = unit_price * quantity
                product_instance.available_stock = product_instance.available_stock - quantity
...
class CartDetailApiView(APIView):
    ...
    def delete(self, request, cart_id, *args, **kwargs):
        ...
        if cart_instance is not None:
            ...
            product_instance.available_stock = product_instance.available_stock + cart_instance.quantity
            product_instance.save()
